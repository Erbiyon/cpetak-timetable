...
export default function ClassSchedule() {
  ...
  const fetchTimetableByTeacher = async (
    ...
    try {
      setLoading(true);
      console.log(
        "Fetching timetable for teacher ID:",
        teacherId,
        "Term Year:",
        termYear,
      );
  ...
  const { cellToSubject, cellColspan, cellSkip } = useMemo(() => {
    ...
    console.log(
      `Total timetable entries: ${timetables.length}, filtering for teacher ID: ${selectedTeacherId}, Term Year: ${currentTermYear}`,
    );
