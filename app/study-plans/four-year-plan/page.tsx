...
export default function FourYearPlan() {
    ...
    return (
        <div className="container mx-auto py-4">
            ...
            <CardStudyPlansCustom>
                <div className="flex justify-between items-center mx-8">
                    <h2>ปี 3 ภาคเรียนที่ 2/{parseInt(year) + 2}</h2>
                    <AddSubjectCustom title={`ปี 3 ภาคเรียนที่ 2/${parseInt(year) + 2}`} />
                </div>
            </CardStudyPlansCustom>
            <CardStudyPlansCustom>
                <div className="flex justify-between items-center mx-8">
                    <h2>ปี 4 ภาคเรียนที่ 1/{parseInt(year) + 3}</h2>
                    <AddSubjectCustom title={`ปี 4 ภาคเรียนที่ 1/${parseInt(year) + 3}`} />
                </div>
            </CardStudyPlansCustom>
            <CardStudyPlansCustom>
                <div className="flex justify-between items-center mx-8">
                    <h2>ปี 4 ภาคเรียนที่ 2/{parseInt(year) + 3}</h2>
                    <AddSubjectCustom title={`ปี 4 ภาคเรียนที่ 2/${parseInt(year) + 3}`} />
                </div>
            </CardStudyPlansCustom>
        </div>
    )
