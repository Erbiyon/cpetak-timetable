...
export default function DveLvcTwoYear() {
        ...
        async function fetchData() {
            ...
            try {
                ...
                if (termRes.ok) {
                    ...
                    // ลองแบบ 1: Query ปกติ
                    const query1 = `/api/subject?termYear=${encodeURIComponent(termData.termYear)}&yearLevel=${encodeURIComponent('ปี 2')}&planType=DVE-LVC`;
    ...
    const handleSubjectUpdate = async () => {
        ...
        try {
            ...
            const planRes = await fetch(`/api/subject?termYear=${encodeURIComponent(termYear || "")}&yearLevel=${encodeURIComponent('ปี 2')}&planType=DVE-LVC`);
            if (planRes.ok) {
