...
export default function DveLvcTwoYear() {
            ...
            if (subject) {
                ...
                try {
                    ...
                    if (response.status === 409 && data.conflicts) {
                        ...
                        console.log("🎉 [FRONTEND-ปี2] บันทึกตารางเรียนสำเร็จ (API จะ sync อัตโนมัติ)", data);
                        setConflicts([]);
    ...
    async function handleRemoveAssignment(subjectId: number) {
        try {
            ...
            console.log("🗑️ [FRONTEND-ปี2] ลบตารางเรียนสำเร็จ (API จะ sync อัตโนมัติ) - วิชา:", subject?.subjectName);
