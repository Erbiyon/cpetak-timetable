...
export default function FourFourYear() {
    ...
    const handleSubjectUpdate = async () => {
        ...
        try {
            ...
            const response1 = await fetch(`/api/subject?termYear=${encodeURIComponent(currentTermYear)}&yearLevel=${encodeURIComponent('ปี 4')}&planType=FOUR_YEAR`);
            if (response1.ok) {
            ...
            <div className="mx-auto px-4">
                <div className="bg-card text-card-foreground rounded-xl border my-5 py-6 shadow-sm mx-auto max-w-7xl">
                    <div className="mx-8 pb-2 text-lg font-semibold">
                        ตารางเรียน เทียบโอน ปี 4 ภาคเรียนที่ {termYear}
                    </div>
