...
export default function FourFourYear() {
    ...
    useEffect(() => {
        if (plans.length > 0) {
            ...
            const year2Plans = plans.filter(plan => plan.yearLevel && plan.yearLevel.includes("ปี 4"));
            console.log("วิชาปี 4:", year2Plans.length);
            console.log("ตัวอย่างวิชาปี 4:", year2Plans.length > 0 ? year2Plans[0] : "ไม่พบ");
        }
    }, [plans]);
